...
export async function POST(request: Request) {
  ...
  try {
    ...
    await run(ffmpegPath, ["-hide_banner", "-loglevel", "error", "-ss", start.toFixed(3), "-i", inputPath, "-t", (end - start).toFixed(3), "-vn", "-map_metadata", "-1", "-codec:a", "libmp3lame", "-q:a", "3", "-y", outputPath]);
